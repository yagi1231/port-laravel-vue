                                    ...
                                    <div class="flex flex-wrap -m-2">
                                            ...
                                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                                ...
                                                <tbody>
                                                    <tr v-for="item in purchase.data" :key="item.id">
                                                        ...
                                                        <td class="px-4 py-3"> {{ item.item_price * item.quantity }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ props.totalPurchases.data[0].total }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ props.totalPurchases.data[0].reservation_name }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="props.totalPurchases.data[0].deleted_at"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ props.totalPurchases.data[0].name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
