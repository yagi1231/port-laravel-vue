        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('reservations.index')"
                                ...
                                <NavLink :href="route('customers.create')"
                                ...
                                <!-- <NavLink :href="route('reservations.aggregate')"
                                    :active="route().current('reservations.aggregate')">
                                    集計2
                                </NavLink> -->
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <NavLink :href="route('customers.create')" :active="route().current('customers.create')">
                            顧客情報登録
                        </NavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4">
                            ...
                            <div class="font-medium text-sm text-gray-500" v-if="$page.props.auth.user">{{
