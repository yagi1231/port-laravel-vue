...
onMounted(() => {
    console.log(props.totalPurchases.data[0].time)
                            ...
                            <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    ...
                                                    {{ dayjs(props.totalPurchases.data[0].time).format('YYYY/MM/DD') }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ props.totalPurchases.data[0].reservation_name }}様
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ Number(props.totalPurchases.data[0].total).toLocaleString() }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ props.totalPurchases.data[0].status }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="props.totalPurchases.data[0].deleted_at"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{ dayjs(props.totalPurchases.data[0].deleted_at).format('YYYY/MM/DD') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex justify-center mt-5">
                                    <div class="p-2 w-1/10">
                                        <Link as="button" :href="route('reservations.edit', { reservation:  props.totalPurchases.data[0].id})" 
                                             v-if="!props.totalPurchases.data[0].deleted_at"
